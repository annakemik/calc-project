...
const titleElementArray = document.getElementsByTagName("h1"); //1
const titleElement = titleElementArray[0].textContent; //1
const buttons = document.getElementsByClassName("handler_btn"); //2
const plusButton = document.querySelector(".screen-btn"); //3
const itemsPercentElement = document.querySelectorAll(".other-items.percent"); //4
const itemsNumberElement = document.querySelectorAll(".other-items.number"); //4
const inputTypeElement = document.querySelector(".rollback > input"); //5
const rangeValueElement = document.querySelector(".rollback > span"); //6
const inputsElement = document.getElementsByClassName("total-input"); //7
for (let i = 0; i < inputsElement.length; i++) {
  console.log(inputsElement[i]);
let screenElement = document.querySelectorAll(".screen"); //8
